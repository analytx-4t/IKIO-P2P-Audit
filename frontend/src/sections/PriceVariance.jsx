          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="app-subtle">
                <tr>
                  <th className="text-left px-4 py-3 text-[10px] font-semibold app-label uppercase">#</th>
                  <th className="text-left px-4 py-3 text-[10px] font-semibold app-label uppercase">Item</th>
                  <th className="text-right px-4 py-3 text-[10px] font-semibold app-label uppercase">Saving (₹)</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
                {top10.map((row, i) => (
                  <tr key={i} className="app-row-hover">
                    <td className="px-4 py-3 text-xs font-semibold app-faint">{row.rank || i + 1}</td>
                    <td className="px-4 py-3 text-[11px] app-title">{row['Description'] || row['Item No.']}</td>
