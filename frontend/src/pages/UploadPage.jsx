...
const FILE_SLOTS = [
  { role: 'vendor_master',    label: 'BP Master Sheet',  icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
  ...
  { role: 'gate_tracking',    label: 'GRN Tracking Report',    icon: 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3' },
  { role: 'item_master',      label: 'Item Master Sheet',       icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="grid grid-cols-1 gap-4 mb-8">
          {FILE_SLOTS.map(({ role, label, icon }) => {
            ...
            return (
              <div
                key={role}
                className="upload-zone group app-card border-2 border-dashed hover:border-slate-500 rounded-lg p-5 cursor-pointer transition-all shadow-sm hover:shadow-md"
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    {file ? (
                      <div className="text-xs text-green-700 dark:text-green-400 truncate">{file.name}</div>
                    ) : (
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <button
            ...
            className="px-8 py-3 rounded-lg text-sm font-semibold transition-all disabled:opacity-30 disabled:cursor-not-allowed bg-slate-600 text-white hover:bg-slate-500 shadow-lg shadow-slate-900/20"
          >
            Submit &amp; Analyze
          </button>
        </div>
